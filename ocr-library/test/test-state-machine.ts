 ...
 */
export async function testStateMachine(testcase: string, calibration: Calibration): Promise<SerializedStateMachineFrame[]> {
    ...
    for (let i = 0; i < Math.min(videoSource.getNumFrames(), 10); i++) {
