import { ChangeDetectionStrategy, Component, ElementRef, Input, OnChanges, Renderer2, RendererFactory2, SimpleChanges, ViewChild } from '@angular/core';
import { Pixels } from 'client/src/app/models/ocr/pixels';
